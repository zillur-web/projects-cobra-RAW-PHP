...
<div class="sl-mainpanel">
      <nav class="breadcrumb sl-breadcrumb">
        ...
        <span class="breadcrumb-item active">Add Settings</span>
      </nav>
              ...
              <div class="row mg-b-25">
                <div class="col-lg-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control taglineErr" id="tagline" placeholder="Tag line" name="tagline">
                ...
                <div class="col-lg-6">
                  <div class="form-group">
                    ...
                    <input type="email" class="form-control emailErr" id="email" placeholder="Enter email address" name="email">
                    <span class="text-danger">
                      <?php 
                ...
                <div class="col-lg-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control phoneErr" id="phone" placeholder="Enter Phone Number" name="phone">
                    <span class="text-danger">
                      <?php 
                ...
                <div class="col-lg-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control office_addressErr" id="office_address" placeholder="Enter Office Address" name="office_address">
                    <span class="text-danger">
                      <?php 
                ...
                <div class="col-lg-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control copyright" id="copyright" placeholder="Enter Copyright" name="copyright">
                    <span class="text-danger">
                      <?php 
                        if (isset($_SESSION['copyright'])) {
                          echo "<style>.copyright{border:1px solid red;}</style>";
                ...
                <div class="col-lg-6">
                  <div class="form-group">
                   ...
                   <textarea class="form-control aboutErr" id="about" name="about" rows="5" placeholder="Enter About"></textarea>
                   <span class="text-danger">
                      <?php 
