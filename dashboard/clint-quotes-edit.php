...
$id = $_GET['id'];
$quote_select = "SELECT * FROM clint_quotes WHERE id = $id";
...
<div class="sl-mainpanel">
  <nav class="breadcrumb sl-breadcrumb">
    ...
    <span class="breadcrumb-item active">Edit Clint Quotes</span>
  </nav>

  <div class="sl-pagebody">
    <div class="sl-page-title">
      <h5>Edit Clint Quotes</h5>
      <?php
      if (isset($_SESSION['ClintEditErr'])) {
        ?>
        <div class="alert alert-success">
          <span>
            <?php
            echo $_SESSION['ClintEditErr'];
            unset($_SESSION['ClintEditErr']);
            ?>
          </span>
        </div>
        <?php
    ...
    <div class="card pd-20 pd-sm-40">
      <div class="form-layout">
        <form action="clint-quotes-edit-post.php" method="POST" enctype="multipart/form-data">
          <div class="row mg-b-25">
            <div class="col-lg-6">
              <div class="form-group">
                <label for="name">Clint Name: <span class="text-danger">*</span></label>
                <input type="text" class="form-control ClintNameErr" id="name" placeholder="Enter Clint Name" name="name" value="<?=$quote['name']?>">
            ...
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control ClintDesignationErr" id="designation" placeholder="Enter Clint Designation" name="designation" value="<?=$quote['designation']?>">
                <span class="text-danger">
                  <?php 
            ...
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <textarea class="form-control ClintquotesErr" id="quotes" name="quotes" rows="5" placeholder="Enter Clint Quotes" value="<?=$quote['quotes']?>"></textarea>
                <span class="text-danger">
                  <?php 
            ...
            <div class="col-lg-3">
              <div class="form-group">
                ...
                <div class="text-center">
                  <img id="image_id" style=" height: 150px; width: 150px;" src="upload/quotes/<?=$quote['image']?>">
                </div>
              </div>
            </div> <!-- col-6 -->
          </div><!-- row -->
